...
public class UbicacionActivity extends AppCompatActivity implements
    ...
    private static class MainActivityLocationCallback
        ...
        private final WeakReference<UbicacionActivity> activityWeakReference;

        MainActivityLocationCallback(UbicacionActivity activity) {
        ...
        public void onSuccess(LocationEngineResult result) {
           UbicacionActivity activity = activityWeakReference.get();
